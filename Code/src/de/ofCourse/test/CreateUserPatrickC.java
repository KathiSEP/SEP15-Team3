...
public class CreateUserPatrickC {
  ...
  public void testCreateUser() throws Exception {
    ...
    driver.findElement(By.id("formCreateUser:lastnameRegister")).sendKeys("Cretu");
    ...
    driver.findElement(By.id("formCreateUser:houseNumberRegister")).sendKeys("5");
    ...
    driver.findElement(By.id("formCreateUser:emailRegister")).sendKeys("strat-fan@web.de");
    driver.findElement(By.id("formCreateUser:usernameRegister")).clear();
    driver.findElement(By.id("formCreateUser:usernameRegister")).sendKeys("PatrickC");
