...
public class CreateUserBasti3 {
  ...
  public void testCreateUser() throws Exception {
    ...
    driver.findElement(By.id("formCreateUser:emailRegister")).sendKeys("g6282972@trbvm.com");
    driver.findElement(By.id("formCreateUser:usernameRegister")).clear();
    driver.findElement(By.id("formCreateUser:usernameRegister")).sendKeys("Basti3");
    ...
    new Select(driver.findElement(By.id("formCreateUser:userRoleSelection"))).selectByVisibleText("Kursleiter");
