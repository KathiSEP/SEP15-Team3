...
public class UserDAO {
    ...
    public static ArrayList<User> getUsers(Transaction trans,
        ...
        default:
            query = ALL_USERS;
            return getAllUsers(conn, pagination, String.format(query, orderParam, dir), limit,
                    offset);
    ...
    private static ArrayList<User> getAllUsers(java.sql.Connection conn,
            PaginationData pagination, String query, int limit, int offset) throws InvalidDBTransferException {
